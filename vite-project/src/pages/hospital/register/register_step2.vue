<template>
    <div class="container">
        ...
        <el-card class="box-card" style="max-width: 950px">
            ...
            <template #header>
                <div class="card-header">
                    <span>请选择就诊人</span>
                    <el-button type="primary" :icon="User" style="width: 130px;">添加就诊人</el-button>
                </div>
            </template>
            <!--卡片的身体部分展示就诊人信息-->
            <div class="user">
        ...
        <el-card style="max-width: 950px">
            ...
            <!--卡片身体部分:展示医生信息-->
            <el-descriptions class="margin-top" :column="2" :border="true">
        ...
        <!--确定挂号按钮-->
        <div class="btn">
            <el-button type="primary" :disabled="currentIndex === -1 ? true : false" @click="submitOrder"
                style="width: 200px;height: 40px;margin-bottom: 10px;background-color: #C7E2FE;">确认挂号</el-button>
        </div>
    </div>
</template>
